...
\addcontentsline{toc}{section}{Concluding remarks}
	...
	The subset $\left\{[x_0:\ldots x_m]\st x_0\neq 0 \right\}$ of $\IP^m(k)$ is isomorphic to $k^m$ via $[x_0:\ldots:x_n]\mapsto\left(\frac{x_1}{x_0},\ldots,\frac{x_n}{x_0}\right)$ by division by $x_0$ and $V(x_0) = \left\{[x_0:\ldots:x_m]\st x_0=0\right\}$, the \emph{infinite hyperplane}, is isomorphic to $\IP^{m-1}(k)$.
