...
\begin{prop}
	For the isomorphism $f^!\Omega_D\simeq \Omega_C$ defined in Proposition~\reff{prop:f!OmegaIso}, the following diagram commutes.
	\begin{diagram*}
...
\end{align*}
(as usual, asterisks denote duals as long as they are clearly no push-forwards/pull-backs), proving a duality like Theorem~\reff{thm:CurvesSerreDuality}\itememph{c}. In particular, for $\Vv=\Omega_C$ we get $H^1(C,\Omega_C)\simeq k$ and it is sufficient to show that this isomorphism satisfies Theorem~\reff{thm:CurvesSerreDuality}\itememph{a}. 
