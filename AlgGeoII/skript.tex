...
\begin{proof}
	...
	\end{align*}
	is quasi-coherent and equals $((M_f)_0)^\sim$ on $\Proj R\setminus V(f)$ (i.e., the first part of exercise~3). Applying this to $M=R[k]$ (the shift of $R$ as in Definition~\reff{def:cone}\itememph{a}) shows that $\Oo(k)$ is quasi-coherent and \eqreff{eq:O(k)isQC} holds.
