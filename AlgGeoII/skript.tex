...
\end{thm}
\begin{rem*}
	Theorem~\reff{thm:CurvesSerreDuality}\itememph{b} and \itememph{c} are called \emph{Serre duality}. They still hold when $C$ is replaced by a \emph{smooth} scheme $X$ over an arbitrary field $k$ and $\Omega_C^1$ by $\omega_X=\bigwedge^{\dim X}\Omega_X^1$.
\end{rem*}
