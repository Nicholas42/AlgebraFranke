...
\end{proof}
To finish this section, we will connect proper morphisms we will prove a famous result that connects proper morphisms to ample line bundles. If $f\colon X\morphism Y$ is a morphism of preschemes and $\Ll$ a line bundle on $X$ such that $\Ll$ is generated by global sections $\lambda_0,\ldots,\lambda_n\in\Ll(X)$. Then we get an  epimorphism of graded $\Oo_X$-algebras
