...
\end{rem}
\begin{rem}
	Before proving Theorem~\reff{thm:cube}, Professor Franke would like to give some motivation why such a result should hold by comparing it to a similar situation in the complex analytic case. This will need a lot of complex analytic theory, which we'll just cite without a proof (for this is only a motivational example).
