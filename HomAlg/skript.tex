...
\end{align*}
Also recall that direct limits are exact\footnote{To see they commute with kernels you can use the explicit construction, commutativity with cokernels follows from the more general fact of cokernels commuting with cokernels, cf.\ \cite[Lemma~A.1.4]{alggeo2}.}, hence commute with taking homology. We thus obtain
