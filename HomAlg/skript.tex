...
\begin{proof}
	...
	Since quotients of divisible $R$-modules are divisible again, the second assertion follows immediately. If $M\morphism I^\bullet$ is an injective resolution of $M$, then so is $0\morphism M\morphism I^0\morphism I^0/M\morphism 0$ already, hence $\idim_R(M)\leq 1$.
...
\end{defi}
\begin{example}
	The sequence $(1,0)$ is always $R$-regular, $(0,1)$ only if $R=0$.
\end{example}
