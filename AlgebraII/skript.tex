...
\end{rem*}
\begin{proof}[Proof of Proposition~\reff{prop:finiteTypeAlgebrasRegular}] We start with the following lemma, which together with its proof is taken from \cite[Tag~00TU]{stacks-project}.
