...
\begin{example}\lbl{ex:universalDerivationPolynomialRing}
    A derivation $d\in\Der_R(R[X_1,\ldots,X_n], M)$ is uniquely determined by $(m_1,\ldots,m_n)\in M^n$ via
    \begin{align*}
...
\begin{proof}
    ...
    \end{itemize}
    Consequently, by the universal property of quotient modules, there is a unique $\delta\in \Hom_A(F_A/K , M)$ such that 
    \begin{diagram}
...
\begin{fact}
    ...
    \begin{alphanumerate}
        \item 
            ...
            \begin{align*}
                0\morphism \Der_R(A/I,M) \morphism \Der_R(A,M) \morphism \Hom_{A/I}(I^2/I, M)
            \end{align*}
            is exact. Herein, the morphism $\Der_R(A/I,M) \morphism \Der_R(A,M)$ is defined by $d\mapsto d\circ\pi$ and $\Der_R(A,M) \morphism \Hom_{A/I}(I^2/I, M)$ by $\delta\mapsto\left(i\mod I^2\mapsto\delta(i)\right)$.
    \end{alphanumerate}
\end{fact}
