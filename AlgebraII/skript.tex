...
\begin{defi}[discrete valuation valuation ring]\lbl{def:discreteValuation}
    A \defemph{discrete valuation valuation ring} (now with $100\%$ more valuation!!) is a domain $R$ with a function $v\colon R\morphism \IN\cup\{\infty\}$ (called the \emph{valuation}) such that
    \begin{alphanumerate}
    \item 
        $v(x)=\infty$ iff $x = 0$.
    \item 
