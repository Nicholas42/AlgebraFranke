...
\begin{proof}[Proof of Proposition~\reff{prop:locFiniteMorph}]
    ...
    Indeed, we have $V(f^*\lambda)=f^{-1}(V(\lambda))$ by Definition~\reff{def:localMorphism}\itememph{b}, moreover by transitivity of the restriction morphisms in $\Oo_X$ and the defining property of the morphism of sheaves $\Oo_Y\morphism[f^*]f_*\Oo_X$ we obtain a commutative diagram
    \begin{diagram*}
