...
\end{cor}
\begin{cor}\lbl{cor:preschemesEqualizers}
	\begin{alphanumerate}
...
\begin{fact}
	\begin{alphanumerate}
		\item Any affine prescheme (in fact, any prescheme such that two arbitrary points have a common affine neighbourhood) is a scheme.
...
\end{fact}
\begin{proof}
	Part \itememph{a} follows from Fact~\reff{fact:separatedDef}. Part \itememph{b} is obvious: If $X\morphism[f]Y$ is a monomorphism and $T\doublemorphism[a][b]X$ are such that $fa=fb$, then $a=b$ and the equalizer under consideration equals $T$. Part \itememph{c} is also trivial, as any $T\doublemorphism[\smash{a}][b]X$ such that $fa=fb$ also satisfies $gfa=gfb$.
	
	Let's prove \itememph{e}. If $f$ is separated, then $\Delta=\Eq\Big(X\times_YX\doublemorphism[p_1][p_2]X\Big)\monomorphism X\times_YX$ is a closed immersion. Conversely, if $\Delta$ is closed and $T\doublemorphism[\smash{a}][b]$ is such that $fa=fb$, then we have a morphism $\tau\colon T\xrightarrow{\smash{(a,b)}}X\times_YX$ and 
	\begin{align*}
	...
	\end{align*}
	by the universal property of the fibre product. As $\xi$ is separated, thus is a closed subprescheme of $T$.
\end{proof}
