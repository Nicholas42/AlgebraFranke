...
\end{defi}
  ...
  \end{rem*}
	...
	\begin{lem}[Yoneda lemma for covariant functors]\lbl{lem:yoneda}
         For any $M\in\Ob \Aa$, $\Cov_M(X) = \Hom_\Aa(M,X)$ defines a covariant functor $\Cov_M=\Hom_\Aa(M,-)\colon \Aa\morphism \cat{Set}$ and 
        \begin{align*}
