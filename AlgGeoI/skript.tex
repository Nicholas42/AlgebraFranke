...
\end{defi}
  ...
  \end{rem*}
	...
	\begin{rem*}
        ...
        \end{alphanumerate}
	\end{rem*}
	\begin{lem}[Yoneda Lemma, functor case or something]\lbl{lem:functorYoneda}
	...
	\end{lem}
	\begin{proof}
        We prove \itememph{a}, \itememph{b} being the dual assertion. The well-definedness of $\mapsto$ is obvious. For $\mapsfrom$ is is necessary to show that $\alpha$ is a natural transformation. For this, let $X\morphism[\nu] Y$ be a morphism in $\Aa$ and $\xi\in\Cov_M(X)$, we have to show $\alpha_Y((\Cov_M(\nu))(\xi)) = F(\nu)(\alpha_X(\xi))$:
        \begin{align*}
