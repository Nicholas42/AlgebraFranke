...
\begin{itemize}
	...
	\item \emph{Topology.} Let $U\subseteq X$, $V\subseteq Y$, $W\subseteq S$ be subsets which are open in their respective space and such that $\xi(U) \cup \upsilon(V)\subseteq W$. Let $\lambda \in\Oo_X(U)\otimes_{\Oo_S(W)} \Oo_Y(V)$. Then the sets of the form
	\begin{align*}
