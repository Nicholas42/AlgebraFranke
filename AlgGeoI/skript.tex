...
\end{proof}
\begin{defi}\lbl{def:localMorphisms}
    \begin{alphanumerate}
        \item 
...
\begin{proof}
	...
	Part \itememph{c} is an easy consequence of \itememph{d}, which we will prove now. We have
	\begin{align*}
