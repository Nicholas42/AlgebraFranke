...
\end{fact}
\begin{proof}
	By Fact~\reff{fact:soberConditions}\itememph{c}, it is enough to show that $\Spec R$ is sober for any ring $R$. Any irreducible closed subset of $\Spec R$ has the form $V(\pp)$ for some $\pp\in\Spec R$ and $\pp$ is a generic point.
\end{proof}
