...
$\!$\begin{tikzpicture}
	\node[opacity=0.125] (wallOfText) at (0,0) {
		\begin{minipage}{\textwidth}
			\setlength{\parskip}{\currentparskip}
			\begin{proof}[\phantom{Proof}]
			...
			\end{proof}
		\end{minipage}};
	\node[rotate=30, red, align=center, draw, line width=2, rounded corners = 1] at (0, 0) {\scalebox{3.75}{\bfseries CONFIDENTIAL}\\\large\bfseries UNTIL EXERCISE SHEET \#7 IS TO BE HANDED IN};
	\node[anchor=north west] at (wallOfText.north west) {\emph{Proof.}};
\end{tikzpicture}
\begin{cor*}
...
\begin{rem*}
    ...
    \end{align*}
    while the stalk of \eqreff{eq:SpecModuleLoc} is $M_\pp$. Thus
    \begin{align*}
    ...
    \end{align*}
    by our construction of the sheafification in subsection \reff{sec:SheafConstructions}, and by the calculation of stalks in that subsection. $(\Oo_{\Spec R})_\pp \isomorphism R_\pp$ and $(\snake M_\pp)\isomorphism M_\pp$.
\end{rem*}
\begin{fact}
