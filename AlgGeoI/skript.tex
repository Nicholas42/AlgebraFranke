...
\end{proof}
    ...
    \appendix
    \chapter{Appendix}
\section{Things you should know about categories}
A category $\Aa$ is a class $\Ob(\Aa)$ of \emph{objects} of $\Aa$ together with:
\begin{alphanumerate}
    \item 
...
\begin{example}
    \begin{itemize}
        ...
        \item 
            The $k$-vector spaces with $k$-linear maps (\emph{Vect}$_K$) or $R$-modules with $R$-linear maps (\emph{$R$-Mod}).
    \end{itemize}
\end{example}
